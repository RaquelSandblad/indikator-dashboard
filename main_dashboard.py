...
def show_boendebarometer():
    """Boendebarometer - Uppsala Universitets verktyg för livsmiljöanalys"""
    st.header("🏠 Boendebarometer - Livsmiljö & Livskvalitet")
    
    st.markdown("""
    **Boendebarometer från Uppsala Universitet**
    
    Detta är Uppsala Universitets forskningsbaserade verktyg för att mäta och analysera livsmiljö och livskvalitet:
    
    - **Livsmiljöfaktorer**: Närhet till service, kollektivtrafik och grönområden
    - **Demografiska förhållanden**: Befolkningssammansättning och utvecklingstrender  
    - **Social sammanhållning**: Trygghet, integration och delaktighet
    - **Hållbar utveckling**: Koppling till Agenda 2030:s hållbarhetsmål
    - **Livskvalitetsmätning**: Forskning om vad som skapar goda boendemiljöer
    
    Verktyget hjälper dig att förstå vilka faktorer som påverkar livskvaliteten i olika områden.
    """)
